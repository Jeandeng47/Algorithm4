...
public class P_3_3_12 {
    ...
    public static void main(String[] args) {
        String str = "E A R C H X M P L";
        String[] letters = str.split("\\s+");
        RBT<String, Integer> rbt = new RBT<>();

        for (String l : letters) {
            rbt.put(l, 0);
            if (l.equals("M") || l.equals("R")) {
                StdOut.println("Insert " + l);
                rbt.printRBT();
                StdOut.println();
            }
        }
